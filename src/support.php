...
<main class="wide-wrap mt195 support-wrapper">
    <div class="l-support">
        <div class="c-hd-title-inner">
            <h2 class="c-hd-title-en zenkaku">Support</h2>
            <p class="c-hd-title-ja">サポート</p>
        </div>
        <div class="c-breadcrumbs">
            <p class="c-breadcrumbs-inner">
                ...
                <span class="c-breadcrumbs-txt">サポート</span>
            </p>
        </div>
    </div>
    <div class="l-category">
        <h4 class="p-about__title">カテゴリーから探す</h4>
        <ul class="p-category__list">
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/card.png 1x, /assets/images/support/card@2x.png 2x">
                        <img src="/assets/images/support/card.png 1x" alt="ご注文/お支払い" class="p-category__item-img">
                    </picture>
                    <span>ご注文/お支払い</span>
                    <img src="/assets/images/support/arw-bottom.svg" alt="下矢印" class="p-category__item-img-arw">
                </a>
            </li>
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/receipt.png 1x, /assets/images/support/receipt@2x.png 2x">
                        <img src="/assets/images/support/receipt.png 1x" alt="領収書等" class="p-category__item-img">
                    </picture>
                    <span>領収書等</span>
                    <img src="/assets/images/support/arw-bottom.svg" alt="下矢印" class="p-category__item-img-arw">
                </a>
            ...
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/lapping.png 1x, /assets/images/support/lapping@2x.png 2x">
                        <img src="/assets/images/support/lapping.png 1x" alt="ラッピング/包装" class="p-category__item-img">
                    </picture>
                    <span>ラッピング/包装</span>
                    <img src="/assets/images/support/arw-bottom.svg" alt="下矢印" class="p-category__item-img-arw">
                </a>
            ...
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/truck.png 1x, /assets/images/support/truck@2x.png 2x">
                        <img src="/assets/images/support/truck.png 1x" alt="配送" class="p-category__item-img">
                    </picture>
                    <span>配送</span>
                    <img src="/assets/images/support/arw-bottom.svg" alt="下矢印" class="p-category__item-img-arw">
                </a>
            ...
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/cancel.png 1x, /assets/images/support/cancel@2x.png 2x">
                        <img src="/assets/images/support/cancel.png 1x" alt="注文変更/キャンセル" class="p-category__item-img">
                    </picture>
            ...
            <li class="p-category__item">
                <a href="#">
                    <picture>
                        <source srcset="/assets/images/support/box.png 1x, /assets/images/support/box@2x.png 2x">
                        <img src="/assets/images/support/box.png 1x" alt="返品・交換" class="p-category__item-img">
                    </picture>
                    <span>返品・交換</span>
                    <img src="/assets/images/support/arw-bottom.svg" alt="下矢印" class="p-category__item-img-arw">
                </a>
            ...
            <div class="p-about__means-list">
                ...
                <div class="p-about__means-card">
                    ...
                    <div class="p-about__means-card-img">
                        <picture>
                            <source srcset="/assets/images/support/jcb.png 1x, /assets/images/support/jcb@2x.png 2x">
                            <img src="/assets/images/support/jcb.png 1x" alt="JCB" class="p-about__means-img">
                        </picture>
                        <picture>
                            <source srcset="/assets/images/support/visa.png 1x, /assets/images/support/visa@2x.png 2x">
                            <img src="/assets/images/support/visa.png 1x" alt="VISA" class="p-about__means-img">
                        </picture>
                        <picture>
                            <source srcset="/assets/images/support/master.png 1x, /assets/images/support/master@2x.png 2x">
                            <img src="/assets/images/support/master.png 1x" alt="MASTERCARD" class="p-about__means-img">
                        </picture>
                        <picture>
                            <source srcset="/assets/images/support/amex.png 1x, /assets/images/support/amex@2x.png 2x">
                            <img src="/assets/images/support/amex.png 1x" alt="AMEX EXPRESS" class="p-about__means-img">
                        </picture>
                        <picture>
                            <source srcset="/assets/images/support/diners.png 1x, /assets/images/support/diners@2x.png 2x">
                            <img src="/assets/images/support/diners.png 1x" alt="Diners Club" class="p-about__means-img">
                        </picture>
                    </div>
