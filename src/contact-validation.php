        ...
        <div class="c-form-wrapper">
            <form action="" method="post" class="c-form">
                ...
                <div class="c-form-group">
                    ...
                    <p class="error-message">＊メールアドレスが誤っている可能性があります。</p>
                </div>
                <div class="c-form-group">
                    ...
                    <p class="error-message">＊メールアドレスが誤っている可能性があります。<br>＊上記のメールアドレスと異なっている可能性があります。</p>
                </div>
                <div class="c-form-group">
                    ...
                    <p class="error-message">＊お問い合わせ種別を1つお選びください。</p>
                </div>
                <div class="c-form-group">
                ...
                <p class="error-message">＊プライバシーポリシーにチェックをつけてください。</p>
                </div>
